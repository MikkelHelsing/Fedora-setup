...
app_name=zen
universal_path_for_installation_directory="/usr/bin"
...
if [ ! -d $universal_path_for_installation_directory ]; then
  ...
  sudo mkdir $universal_path_for_installation_directory
fi

sudo mv $open_tar_application_data_location $app_installation_directory
